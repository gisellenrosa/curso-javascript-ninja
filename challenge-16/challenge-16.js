...
(function() {
  ...
  */
  ...
  var fullName = 'giselle-nepomuceno-rosa'
  var newFullName = fullName.split('-').map((name)=> name.charAt(0).toUpperCase() + name.slice(1))
  ...
  */
  console.log( '\nMeus amigos:' );
  var friends = ['PingoDeSol', 'PingoDeLua', 'PingoDeMar', 'PingoDeCeu', 'PingoD`Agua' ]
  ...
  */
  console.log( '\nEra "Roberto", agora é:' );
  var nameRobert = 'Roberto';
  var newRobert = nameRobert.replace('to', 'ta');
  ...
  */
  console.log( '\nParte de uma string:' );
  console.log('Giselle'.substring(7,2))
