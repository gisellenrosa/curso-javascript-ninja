(function(){
  ...
  */
  ...
  var modCalc = calculator(mod)
  if(sub && mult && div && modCalc ){
    number1 = 10;
    number2 = 12;
    ...
    console.log(showOperationMessage(mod, number1, number2), modCalc(number1, number2) )
  ...
  */
  ...
  if(sub ){
    number1 = 10;
    number2 = 12;
    console.log(showErrorMessage(subtraction) )
